...
function generateTestToken(): string {
  // Produces a random 32-hex-char string useful for test/dev environments
  // where Agora App does NOT enforce token authentication.
...
export function LiveChat() {
  ...
  const handleGenerate = () => {
    setTokenInput(generateTestToken())
  }
        ...
        <div className="px-4 py-4 flex flex-col gap-3 border-b">
          ...
          <div className="flex gap-1.5">
            ...
            <Button
              ...
              title="Generate random test token"
            >
          ...
          <p className="text-[10px] text-muted-foreground leading-relaxed">
            Leave blank to connect without a token (works if your Agora app has token auth disabled).
            Use "Generate" to create a random test key.
          </p>
        </div>
      )}
